                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/60">
                    <div className="w-11/12 text-center md:w-2/3 lg:w-1/2">
                        <Typography
                            variant="h1"
                            color="white"
                            className="mb-4 text-lg sm:text-2xl md:text-4xl lg:text-5xl text-[#D98855] font-bold"
                        >
                        ...
                        <Typography
                            variant="lead"
                            color="white"
                            className="mb-8 text-sm sm:text-base md:text-lg lg:text-xl opacity-90"
                        >
                ...
                <div className="absolute inset-0 flex items-center bg-black/50">
                    <div className="w-11/12 pl-4 md:w-2/3 md:pl-12 lg:pl-16">
                        <Typography
                            variant="h1"
                            color="white"
                            className="mb-4 text-lg sm:text-2xl md:text-4xl lg:text-5xl font-bold"
                        >
